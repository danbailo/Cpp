...
int main(int argc, char *argv[])
{
	...
	//organiza os parametros mais a direita para imprimir algo com mais elegancia

	//no caso o inteiro que esta no parametro da funcao setw, é o tamanho
	//de caracteres que esta sendo alocado
